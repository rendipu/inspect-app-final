const MENUS = [
  { key: 'dashboard',     icon: '▦',  label: 'Dashboard', roles: ['admin','group_leader','mekanik','planner'] },
  ...
  { key: 'analytics',   icon: '📊', label: 'Analitik',  roles: ['admin','group_leader','mekanik','planner'] },
  { key: 'approvals',   icon: '✅', label: 'Approval',  roles: ['group_leader'] },
  { key: 'plannerorders', icon: '📋', label: 'Orders',  roles: ['planner'] },
